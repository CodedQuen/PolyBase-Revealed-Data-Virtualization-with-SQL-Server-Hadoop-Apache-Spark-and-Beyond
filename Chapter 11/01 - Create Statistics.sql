...
DBCC SHOW_STATISTICS ('dbo.NorthCarolinaPopulation', 'sNorthCarolinaPopulation_Year_Name')
GO
...
CREATE STATISTICS [sParkingViolationsSQLControl_PlateID] ON [dbo].[ParkingViolationsSQLControl]
(
    PlateID
) WITH SAMPLE 40 PERCENT;